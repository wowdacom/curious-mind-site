      ...
      <div class="w-full grid lg:grid-cols-3 gap-2">
        <div class="py-8 px-4 bg-white">
          <div class="h-full flex items-start">
            ...
            <div class="flex-grow pl-6 flex flex-col justify-between h-full">
              <div class="title">
                <h2
                ...
                <p class="leading-relaxed mb-5">- 我們如何重建生活</p>
              </div>
          ...
          <div class="h-full flex items-start">
            ...
            <div class="flex-grow pl-6 flex flex-col justify-between h-full">
              <div class="title">
                ...
                <p class="leading-relaxed mb-5">- 從生物效度上的觀點</p>
              </div>
              ...
              <a class="inline-flex items-center">
                ...
                <span class="flex-grow flex flex-col pl-3">
                  <span class="title-font font-medium text-gray-900"
                    >American Psychological Association</span
                  >
                </span>
              </a>
            </div>
